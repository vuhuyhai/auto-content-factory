    ...
    <section className="w-full bg-white py-12 px-4 md:py-16 md:px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            <div className="flex h-20 w-20 items-center justify-center rounded-full border-2 border-gray-300 bg-gradient-to-br from-gray-200 to-gray-300">
              <span className="text-2xl font-bold text-gray-700">VH</span>
            </div>
            ...
            <p className="text-base text-gray-700 leading-relaxed mt-4 max-w-md">
          ...
          <div className="flex flex-col gap-4">
            {PROOF_CARDS.map((card) => (
              ...
              >
                ...
                <p className="text-sm text-gray-700 mt-1">{card.caption}</p>
              </div>
            ))}
          </div>
        </div>
